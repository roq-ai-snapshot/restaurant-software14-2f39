...
function OrdersCreatePage() {
  ...
  const formik = useFormik<OrdersInterface>({
    initialValues: {
      ...
      pickup_delivery_time: new Date(new Date().toDateString()),
      customer_id: null,
      restaurant_id: null,
      order_items: [],
    },
    ...
    <AppLayout>
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="pickup_delivery_time" mb="4">
            <FormLabel>Pickup/Delivery Time</FormLabel>
            <DatePicker
              dateFormat={'dd/MM/yyyy'}
              selected={formik.values.pickup_delivery_time}
              onChange={(value: Date) => formik.setFieldValue('pickup_delivery_time', value)}
            />
          </FormControl>
